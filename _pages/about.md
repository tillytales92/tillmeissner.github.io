...
I am currently a **Research Officer at LSE**. I am working on an [International Growth Centre (IGC)](https://www.theigc.org/)-funded project on Green Foreign Direct Investment in Africa: using the EU Taxonomy of Sustainable Activities and GPT-4, we build a novel dataset of green inward FDI for IGC partner countries, and conduct a Rwanda case study combining GVC mapping, a comparison of Rwanda's and the EU's green taxonomies, and stakeholder interviews to gain insights into policy conditions for green growth via FDI. I also contributed to the [STEG](https://grp.cepr.org/steg/) project *"Migration in the Face of Climate Change: Assessing the Potential of Ultra-Poor Graduation Programs"* — processing climate datasets using R and Google Earth Engine and linking them to household survey data from Upper Egypt to analyse agricultural households' adaptation strategies.

Previously at LSE, I worked as a **Graduate Research & Teaching Assistant** for GY103 (Contemporary Europe) and GY140 (Introduction to Geographical Research), and was recognised with LSE Class Teacher Awards in 2022, 2024, and 2025.
...
**Languages:** German (native), English (bilingual), French (fluent, C1), Spanish (basic, B1).
